...
public class delete_room extends JFrame {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                roomBtn.addActionListener(new ActionListener() {
                    ...
                    if (choice == JOptionPane.YES_OPTION) {
                        deleteRoom(roomNumber, roomType, roomStatus);
                        return;
                    }
                    }
                });
    ...
    public void deleteRoom(String roomNumber, String roomType, String roomStatus) {
        String fileName = "room.txt";
        String targetText = roomNumber + " " + roomType + " " + roomStatus;
