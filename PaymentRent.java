    ...
    public PaymentRent() {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                roomBtn.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent event) {
                        ...
                        try (BufferedWriter writer = new BufferedWriter(new FileWriter("payment_history.txt", true))) {
                            writer.write(roomNumber + " "+ "0 " + totalCost + " " + currentDate);
                            writer.newLine();
                        ...
                        new RoomSummary(roomNumber, roomType, roomPrice, electricityCost, totalCost);
                    }
                });
                ...
                container.revalidate(); // รีเฟรชการแสดงผลของ container
